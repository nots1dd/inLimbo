...
\hypertarget{build__emscripten_2__deps_2ftxui-src_2include_2ftxui_2component_2receiver_8hpp_source}{}\label{build__emscripten_2__deps_2ftxui-src_2include_2ftxui_2component_2receiver_8hpp_source}\index{build\_emscripten/\_deps/ftxui-\/src/include/ftxui/component/receiver.hpp@{build\_emscripten/\_deps/ftxui-\/src/include/ftxui/component/receiver.hpp}}
...
\DoxyCodeLine{00055\ \textcolor{keyword}{class\ }SenderImpl\ \{}
...
\DoxyCodeLine{00063\ \ \ \textcolor{keyword}{friend}\ \textcolor{keyword}{class\ }\mbox{\hyperlink{classftxui_1_1ReceiverImpl}{ReceiverImpl}}<T>;}
\DoxyCodeLine{00064\ \ \ SenderImpl(\mbox{\hyperlink{classftxui_1_1ReceiverImpl}{ReceiverImpl<T>}}*\ consumer)\ :\ receiver\_(consumer)\ \{\}}
\DoxyCodeLine{00065\ \ \ \mbox{\hyperlink{classftxui_1_1ReceiverImpl}{ReceiverImpl<T>}}*\ receiver\_;}
\DoxyCodeLine{00066\ \};}
\DoxyCodeLine{00067\ }
\DoxyCodeLine{00068\ \textcolor{keyword}{template}\ <\textcolor{keyword}{class}\ T>}
\DoxyCodeLine{00069\ \textcolor{keyword}{class\ }ReceiverImpl\ \{}
...
\DoxyCodeLine{00074\ \ \ \ \ \textcolor{keywordflow}{return}\ std::unique\_ptr<SenderImpl<T>>(\textcolor{keyword}{new}\ \mbox{\hyperlink{classftxui_1_1SenderImpl}{SenderImpl<T>}}(\textcolor{keyword}{this}));}
\DoxyCodeLine{00075\ \ \ \}}
...
\DoxyCodeLine{00112\ \ \ \textcolor{keyword}{friend}\ \textcolor{keyword}{class\ }\mbox{\hyperlink{classftxui_1_1SenderImpl}{SenderImpl}}<T>;}
\DoxyCodeLine{00113\ }

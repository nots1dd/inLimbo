...
/* Server only has the password hash; Client will have to give the password in and the server will
 * compute the hash of salt+password and compare it with the given password hash in config.toml */
const std::string PASSWORD_HASH =
  std::string(parseTOMLField(PARENT_FTP, PARENT_FTP_FIELD_PWD_HASH));

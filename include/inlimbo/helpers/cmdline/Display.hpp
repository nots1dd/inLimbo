...
// ------------------------------------------------------------
inline void printAlbums(const SongTree& tree, const std::optional<Artist>& artist = std::nullopt)
{
...
// ------------------------------------------------------------
inline void printSongs(const SongTree& tree, SongPredicate pred = {})
{
  std::cout << "\nSongs:\n";
  std::cout << "────────────────────────────\n";
...
inline void printSongsByArtist(const SongTree& tree, const Artist& artist)
{
...
inline void printSongsByAlbum(const SongTree& tree, const Album& album)
{
...
inline void printSongsByGenre(const SongTree& tree, const Genre& genre)
{
...
// ------------------------------------------------------------
inline void printSongPaths(const SongTree& tree, SongPredicate pred = {})
{
  std::cout << "\nSong Paths:\n";
  std::cout << "────────────────────────────\n";
...
// ------------------------------------------------------------
inline void printAlbum(const SongTree& tree, const Artist& artist, const Album& album)
{

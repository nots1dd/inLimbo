...
#define INLIMBO_COMPILER_VERSION_STR \
  STRINGIFY(INLIMBO_COMPILER_VERSION_MAJOR) "." STRINGIFY(INLIMBO_COMPILER_VERSION_MINOR)
...
#define INLIMBO_COMPILER_VERSION_FULL_STR   \
  ...
  "." STRINGIFY(INLIMBO_COMPILER_VERSION_MINOR) "." STRINGIFY(INLIMBO_COMPILER_VERSION_PATCH)
#else
